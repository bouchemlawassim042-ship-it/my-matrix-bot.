...
if entry_price is not None:
    trade = manage_trade(entry=entry_price,atr=0.3,asset=best_asset,trade_type=signal,resistance=res,support=sup)
else:
    trade = None

print("Market Scores:",scores)
print("Best Asset:",best_asset)
print("Resistance:",res,"Support:",sup)
print("Orders:",orders)
print("Lot Size:",lot)
print("Entry Signal:",signal)
print("Entry Price:",entry_price)
print("Trade Management:",trade)
